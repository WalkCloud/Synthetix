...
export function RagTab() {
  ...
  async function saveRag() {
    ...
    try {
      ...
      setRagMsg(d.success ? { type: "success", text: t.settings.rag.saved } : { type: "error", text: d.error });
    } catch {
      setRagMsg({ type: "error", text: t.settings.rag.saveFailed });
    } finally {
      setSavingRag(false);
    }
  }
    ...
    <div className="space-y-6">
      <div className="bg-card border rounded-[16px]">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-semibold text-foreground">{t.settings.rag.vectorDatabaseProvider}</h3>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4">
            <CardSelector
              ...
              title={t.settings.rag.localTitle}
              description={t.settings.rag.localDesc}
            />
            <CardSelector
        ...
        <div className="bg-card border rounded-[16px]">
          <div className="flex items-center justify-between px-6 py-5 border-b">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-semibold text-foreground">{t.settings.rag.postgresqlConfig}</h3>
            </div>
          </div>
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <input type="password" className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder={t.settings.rag.enterPassword} value={ragPgPassword} onChange={(e) => setRagPgPassword(e.target.value)} />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="bg-card border rounded-[16px]">
          <div className="flex items-center justify-between px-6 py-5 border-b">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-semibold text-foreground">{t.settings.rag.milvusConfig}</h3>
            </div>
          </div>
          <div className="p-6 space-y-4">
            <div>
            ...
            <div>
              <label className="block text-[13px] font-medium text-muted-foreground mb-1.5">{t.settings.rag.tokenOptional}</label>
              <input className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder={t.settings.rag.enterToken} value={ragMilvusToken} onChange={(e) => setRagMilvusToken(e.target.value)} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[13px] font-medium text-muted-foreground mb-1.5">{t.settings.rag.usernameOptional}</label>
              ...
              <div>
                <label className="block text-[13px] font-medium text-muted-foreground mb-1.5">{t.settings.rag.passwordOptional}</label>
                <input type="password" className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder={t.settings.rag.enterPassword} value={ragMilvusPassword} onChange={(e) => setRagMilvusPassword(e.target.value)} />
              </div>
            </div>
            <div>
              <label className="block text-[13px] font-medium text-muted-foreground mb-1.5">{t.settings.rag.databaseName}</label>
        ...
        <div className="bg-card border rounded-[16px]">
          <div className="flex items-center justify-between px-6 py-5 border-b">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-semibold text-foreground">{t.settings.rag.qdrantConfig}</h3>
            </div>
          </div>
          <div className="p-6 space-y-4">
            <div>
            ...
            <div>
              ...
              <input type="password" className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder={t.settings.rag.enterApiKey} value={ragQdrantApiKey} onChange={(e) => setRagQdrantApiKey(e.target.value)} />
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-card border rounded-[16px]">
        <div className="flex items-center justify-between px-6 py-5 border-b">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-semibold text-foreground">{t.settings.rag.neo4jGraphStorage}</h3>
          </div>
        </div>
        <div className="p-6 space-y-4">
          <p className="text-[13px] text-muted-foreground">{t.settings.rag.neo4jDesc}</p>
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[13px] font-medium text-muted-foreground mb-1.5">{t.settings.database.password}</label>
              <input type="password" className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder={t.settings.rag.enterPassword} value={ragNeo4jPassword} onChange={(e) => setRagNeo4jPassword(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border rounded-[16px]">
        <div className="flex items-center justify-between px-6 py-5 border-b">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-semibold text-foreground">{t.settings.rag.saveConfiguration}</h3>
          </div>
        </div>
        <div className="p-6">
          <div className="flex gap-3">
            <button type="button" onClick={saveRag} disabled={savingRag} className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white font-semibold rounded-lg hover:bg-primary-light transition-all text-sm disabled:opacity-50">
              {savingRag ? t.common.actions.loading : (
                <>
                  ...
                  {t.settings.rag.saveVectorDbSettings}
                </>
              )}
            </button>
            {ragMsg && (
