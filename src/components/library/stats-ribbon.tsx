  ...
  return (
    <div className="grid grid-cols-4 gap-4 mb-6 animate-fade-in-up">
      ...
      <div className="bg-card border border-border rounded-[12px] p-4 flex items-center gap-3.5">
        ...
        <div><div className="text-[22px] font-bold text-foreground font-display">{indexedPct}%</div><div className="text-xs text-muted-foreground">{t.library.actions.indexed}</div></div>
      </div>
      <div className="bg-card border border-border rounded-[12px] p-4 flex items-center gap-3.5">
