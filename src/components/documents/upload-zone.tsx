...
export function UploadZone({ onFiles }: UploadZoneProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-[16px] font-semibold text-foreground mb-1">Drag & Drop files or folders here</h3>
      <p className="text-[14px] text-muted-foreground mb-5">Supports PDF, DOCX, PPTX, XLSX, HTML, EPUB</p>
