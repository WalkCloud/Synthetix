        ...
        {items.map((item) => {
          ...
          return (
            <div key={item.id} className="flex items-center gap-4 py-4 border-b border-[#F4F2EF] last:border-b-0">
              ...
              <button onClick={() => onRemove(item.id)} className="w-8 h-8 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-[#F4F2EF] hover:text-foreground transition-colors shrink-0">
