    ...
    <div>
      ...
      >
        ...
        <input
          ...
          placeholder={t.writing.outlinePanel.sectionTitlePlaceholder}
        ...
        <input
          ...
          placeholder={t.writing.outlinePanel.wordsPlaceholder}
        />
        <button
    ...
    <div className="outline-panel bg-card border-r border-border p-5 overflow-y-auto h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        ...
        {editing ? (
          ...
          <button
            ...
            title={t.writing.outlinePanel.editOutline}
          >
      ...
      <div className="flex-1 overflow-y-auto">
        {editing ? (
          <div className="space-y-1">
              ...
              <div key={item.id} className="rounded-lg border border-border bg-card shadow-sm overflow-hidden">
                ...
                {visibleEditItems.filter((s) => s.parentId === item.id).length > 0 && (
                  <div className="border-t border-border bg-muted/40 px-2 py-1">
                    ...
                    >
                      <Plus className="h-3 w-3" /> {t.writing.outlinePanel.addSubSection}
                    </button>
                  </div>
                )}
                {visibleEditItems.filter((s) => s.parentId === item.id).length === 0 && (
            ...
            >
              <Plus className="h-3.5 w-3.5" /> {t.writing.outlinePanel.addSection}
            </button>
          </div>
        ) : (
      ...
      <div className="mt-4 pt-4 border-t border-border">
        <div className="text-xs text-muted-foreground mb-1.5 font-medium">
          {format.template(t.writing.outlinePanel.sectionsCompleted, { completed: completedCount, total: totalCount })}
        </div>
