...
3. **ai_signatures**: Does the text contain typical AI writing patterns such as: "delve", "tapestry", "it's worth noting", "importantly", "in today's era", "with the continuous development of", every paragraph starting with a topic sentence, lists of exactly 3 items, symmetrical paragraph lengths, hedging before every claim? This is a warning.
...
5. **empty_filler**: Does the text contain vague filler phrases like "various methods", "multiple aspects", "comprehensive improvement", "robust support", "empowering users" without specific details? This is a warning.
